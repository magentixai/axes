...
| Path | Contents |
|---|---|
| [`docs/`](docs/) | The standard: doctrine, report profile, module map, field catalogue, vocabularies, conformance, extensions, canonicalisation, access model, threat model, standards alignment, [interop notes](docs/interop/three-layer-evidence-coverage.md) ([x402 & anchoring](docs/interop/x402-and-anchoring.md)) |
