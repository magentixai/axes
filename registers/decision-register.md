...
| D-016 | **Microsoft Agent 365 / Purview are adjacent governance surfaces, not AXES substitutes** - map exportable events into SE where useful; differentiate control-plane vs evidence-plane; independence argument mandatory in Magentix positioning (Microsoft-operated logs of Microsoft-estate agents are not independent auditor evidence). ARBITR import pack tracked as BLD-031 | decided 2026-07-24 | [`docs/interop/agent365-purview-se-mapping.md`](../docs/interop/agent365-purview-se-mapping.md), [`docs/interop/agent365-arbitr-brief.md`](../docs/interop/agent365-arbitr-brief.md) |
